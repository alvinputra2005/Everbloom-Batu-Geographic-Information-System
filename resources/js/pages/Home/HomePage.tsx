...
export default function HomePage() {
    ...
    const featuredDestinations = getFeaturedDestinations(activeCategory) as HomeDestination[];

    return (
        <MainLayout>
            <div className="home-bloom-page overflow-hidden bg-[var(--app-surface)] text-[var(--app-text)]">
                <HeroSection selectedDate={selectedDate} onSelectDate={setSelectedDate} />
                <JourneySection />
